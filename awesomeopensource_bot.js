...
const welcomeMarkdown = `这里是 @awesomeopensource 的投稿机器人，点击下面的'我要投稿'按钮开始投稿。`;

const aboutMarkdown = `*关于此Bot*
这里是 @awesomeopensource 的投稿机器人。反馈 @EEYHN。
...
const step1Text = '输入你想要推荐的开源项目名称：';
const step2Text = '输入项目的链接（Github链接或官网链接）：';
const step3Text = '一段文字简短介绍一下这个项目：';
const step4Text = '你还可以插入一个关于这个项目的图片或者视频，必须是链接(可选)：';
const step5Text = '最后请确认你的投稿：';
const rejectStep1Text = '输入驳回原因：';
const successText = '投稿成功，谢谢投稿！';
const canceledText = '已取消操作';
const pubilcText = '这条投稿已经被接受，发到频道了。';
